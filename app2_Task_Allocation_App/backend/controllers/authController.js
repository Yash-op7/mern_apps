    ...
    */
    ...
    try {
        ...
        return res.status(500).json({
            message: '❌ Something went wrong while attempting to create the given user, please try again.',
            error: err
        })
    }
...
const signin = async (req, res) => {
    ...
    */
    ...
    try {
        ...
        return res.status(500).json({
            message: '❌ Something went wrong while attempting to fetch the given user details, please try again.',
            error: err
        });
    }
    ...
    const token = jwt.sign(objectToSign, )
